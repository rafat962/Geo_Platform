...
const AddReq = () => {
    ...
    return (
        <div className="w-full h-full bg-sec rounded-4xl overflow-hidden">
            <div ref={viewRef} className={'w-404  h-90 rounded-3xl'}></div>
            ...
            <div>
                <div class="flex justify-center space-x-115 ">
                    <button onclick="showStep(0)" id="step0" class="flex flex-col items-center text-orange-600">
                        <div class="w-8 h-8 flex items-center justify-center rounded-full border-2 border-orange-600 hover:bg-gray-300">i</div>
                        <span class="text-sm mt-1 hover:font-bold">Personal Information</span>
                    </button>
                    <button onclick="showStep(1)" id="step1" class="flex flex-col items-center text-gray-400">
                        <div class="w-8 h-8 flex items-center justify-center rounded-full border-2 border-gray-400 hover:bg-gray-300 ">🪧</div>
                        <span class="text-sm mt-1 hover:font-bold">billboard Details</span>
                    </button>
                    <button onclick="showStep(2)" id="step2" class="flex flex-col items-center text-gray-400">
                        <div class="w-8 h-8 flex items-center justify-center rounded-full border-2 border-gray-400 hover:bg-gray-300">💳</div>
                        <span class="text-sm mt-1 hover:font-bold">Payment</span>
                    </button>
                </div>
                <div class="px-10 m-2 flex flex-wrap justify-between items-center gap-2">
                    <div class="overflow-auto bg-teal-50 h-100 w-100 rounded-2xl mb-3">
                        ...
                        <div>
                            <form  action="?????????????" method="POST">
                                ...
                                <div class="font-bold p-1  m-2 dark:text-gray-700">
                                    <label htmlFor="Billboard Size">Billboard Size:</label>
                                    <input 
                                        className="w-full p-2 mt-2 border border-gray-300 rounded-lg text-center"
                                        type="text"
                                        id="billboard_size"
                                ...
                                <div class="font-bold p-1  m-2 dark:text-gray-700">
                                    <label htmlFor="Billboard Oriantaion">Billboard Oriantaion:</label>
                                    <select 
                                        className="w-full p-2 mt-2 border border-gray-300 rounded-lg text-center"
                                        ...
                                        >
                                            ...
                                            <option value="شارع داخلي">شارع داخلي</option>
                                            <option value="مزدوج" >مزدوج</option>
                                    </select>
                                </div>

                                <div class="font-bold p-1  m-2 dark:text-gray-700">
                                    <label htmlFor="Billboard status">Billboard status:</label>
                                    <select 
                                        className="w-full p-2 mt-2 border border-gray-300 rounded-lg text-center"
                                ...
                                <div class="font-bold p-1  m-2 dark:text-gray-700 ">
                                    <label htmlFor="billboard rent date">billboard rent date:</label>
                                    <div class="m-2 font-semibold">
                                        <label htmlFor="from" class="m-2 font-medium" >from:</label>
                                        <input
                                            type="date"
                                            id="from"
                                            name="from"
                                            ...
                                            className="w-full p-2 mt-2 border border-gray-300 rounded-lg text-center "
                                        />
                                        <label htmlFor="to" class="m-2 font-medium">to:</label>
                                        <input
                                            type="date"
                                            id="to"
                                            name="to"
