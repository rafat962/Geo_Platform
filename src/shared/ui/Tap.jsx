    ...
    return (
        <div className="tap dark:bg-gray-800 bg-white ring shadow-xl  ring-gray-900/5">
            ...
            <div className="dIRect ">
                ...
                ></div>
                {/* img */}
                <div className="w-18 h-18 object-cover inset-7 absolute -rotate-40 opacity-90">
            ...
            <div className="flex flex-col items-end justify-center w-full h-full pr-4">
                ...
                <p className="text-xl  text-gray-500 dark:text-gray-200 font-semibold max-w-40 text-end text-wrap">
                    {name}
                </p>
            </div>
        </div>
