    ...
    return (
        <div className={`tap  ring shadow-xl  ring-gray-900/5`}>
            ...
            >
                ...
                <p
                    className={`text-lg md:text-xl  text-gray-500 dark:text-gray-200 font-semibold   ${!isRTL ? "text-start max-w-26 md:max-w-43" : "text-end max-w-25 md:max-w-40"}    text-wrap`}
                >
                    {name}
                </p>
            </div>
